...
export default function LoginPage() {
  ...
  // But only if there's an active jt_session (prevents redirect loop after logout)
  useEffect(() => {
    if (isAuthenticated && staff) {
      const existingSession = localStorage.getItem('jt_session');
      if (!existingSession) {
        // User just logged out — don't auto-redirect, just save for PIN login
        return;
      }
